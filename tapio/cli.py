...
def adk_server(
    ...
    try:
        ...
        from tapio.config.settings import get_default_model, has_gemini_api_key
        ...
        typer.echo("🚀 Starting Tapio ADK Server...")
...
def _setup_gemini_key() -> None:
    ...
    try:
        ...
        _ = model.generate_content("Hello! Just testing the API key.")
